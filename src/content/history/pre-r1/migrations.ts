import { gateSatisfied } from "./progress.ts";
import type { GameContent, PlayerPosition, ProfileId } from "./types.ts";
import type { CompletedStaticLayout, StaticLayout } from "./static-puzzle.ts";
