import { createGame, dispatch } from "./engine.ts";
import { areaData, supplyProgress } from "./progress.ts";
import { validateStaticDefinition } from "./static-puzzle.ts";
import { validateRealtimeDefinition } from "./realtime.ts";
import type {
  GameCommand,
  GameContent,
  GameState,
